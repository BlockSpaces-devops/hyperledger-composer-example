...
if [ $NETWORK_EXISTS -eq "0" ]; then
    ...
    composer network start --card $INSTALLER_CARD --networkAdmin $NETWORK_ADMIN --networkAdminEnrollSecret $NETWORK_ADMIN_SECRET --archiveFile $NEW_ARCHIVE --file $NETWORK_ADMIN_CARD_PATH --loglevel "DEBUG"
